export const InfoText: React.FC = () => {
  return (
    <div className="info">
      <p>
        Today’s News Online (TNO) is a service that allows people to see all of BC’s news at a
      ...
      <p>
        The following is a pinned message and announcement for all subscribers to the TNO News
        Service. Please be aware that system maintenance will occur this Friday, from 8:00AM to 5PM.
      </p>
      <div className="email">

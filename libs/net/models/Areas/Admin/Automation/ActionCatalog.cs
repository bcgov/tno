...
public static class ActionCatalog
{
    ...
    public static readonly IReadOnlyDictionary<string, ActionDescriptor> Types = new[]
    {
        ...
        new ActionDescriptor("select-top", "Select Top Scored", "distribute", false, true, false, _once, new[]
        {
            ...
            new FieldSpec("value", "contentActionValue", false, "What the stamped content action stores. A yes/no action stores true or false; an action that records a value (Commentary's timeout in hours, for example) needs that value."),
        },

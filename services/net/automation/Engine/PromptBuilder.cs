...
public class PromptBuilder
{
    ...
    public PromptBuilder(AutomationDefinition definition, LookupModel? lookups, RunContext context, JsonSerializerOptions jsonOptions)
    {
    ...
    /// </summary>
    public string Resolve(PromptDefinition prompt)
    {
        var text = "";
    ...
    {
        List<ContentEntry> snapshot;
        lock (_context.Sync)
        {
            snapshot = _context.Collections.TryGetValue(name, out var list) ? list.ToList() : new List<ContentEntry>();
        }

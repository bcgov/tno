...
public class ContributorModel : BaseTypeModel<int>
{
    ...
    public ContributorModel(TNO.API.Areas.Editor.Models.Content.ContributorModel model)
    {
        this.Id = model.Id;
    ...
    /// </summary>
    /// <param name="model"></param>
    public ContributorModel(TNO.API.Areas.Services.Models.Report.ContributorModel model)
    {
        this.Id = model.Id;
        this.Name = model.Name;
        this.Description = model.Description;
    ...
    /// </summary>
    /// <param name="model"></param>
    public ContributorModel(TNO.API.Areas.Services.Models.ReportInstance.ContributorModel model)
    {
        this.Id = model.Id;
        this.Name = model.Name;
        this.Description = model.Description;

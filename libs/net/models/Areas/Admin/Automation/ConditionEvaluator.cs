...
/// <summary>
/// ConditionResult record, the outcome of a condition evaluation, with a human-readable detail
...
public record ConditionResult(bool Passed, string Detail);
...
public static class ConditionEvaluator
{
    ...
    private static ConditionResult EvaluateLeaf(string fieldName, string op, JsonElement? value, string? actual)
    {
        ...
        switch (op)
        {
            ...
            case ConditionOps.Matches:
                ...
                break;
            case ConditionOps.LengthLessThan:
                passed = (actual ?? "").Length < AsNumber(value);
                break;
            case ConditionOps.LengthGreaterThan:
                passed = (actual ?? "").Length > AsNumber(value);
                break;
            case ConditionOps.GreaterThan:
                passed = TryNumber(actual, out var gt) && gt > AsNumber(value);
                break;
            case ConditionOps.LessThan:
            ...
            case ConditionOps.HasTag:
            case ConditionOps.HasAction:

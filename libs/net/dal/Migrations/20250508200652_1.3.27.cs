        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    age_group1_label = table.Column<string>(type: "character varying(250)", maxLength: 250, nullable: false),
                    age_group2 = table.Column<float>(type: "real", nullable: false),
                    age_group2_label = table.Column<string>(type: "character varying(250)", maxLength: 250, nullable: false),
                    age_group3 = table.Column<float>(type: "real", nullable: false),
                    age_group3_label = table.Column<string>(type: "character varying(250)", maxLength: 250, nullable: false),
                    age_group4 = table.Column<float>(type: "real", nullable: false),
                    age_group4_label = table.Column<string>(type: "character varying(250)", maxLength: 250, nullable: false),
                    page_views1 = table.Column<float>(type: "real", nullable: false),
                    page_views1_label = table.Column<string>(type: "character varying(250)", maxLength: 250, nullable: false),
                    page_views2 = table.Column<float>(type: "real", nullable: false),
                    page_views2_label = table.Column<string>(type: "character varying(250)", maxLength: 250, nullable: false),
                    page_views3 = table.Column<float>(type: "real", nullable: false),
                    page_views3_label = table.Column<string>(type: "character varying(250)", maxLength: 250, nullable: false),
                    page_views4 = table.Column<float>(type: "real", nullable: false),
                    page_views4_label = table.Column<string>(type: "character varying(250)", maxLength: 250, nullable: false),
                    watch_time1 = table.Column<float>(type: "real", nullable: false),
                    watch_time1_label = table.Column<string>(type: "character varying(250)", maxLength: 250, nullable: false),
                    watch_time2 = table.Column<float>(type: "real", nullable: false),
                    watch_time2_label = table.Column<string>(type: "character varying(250)", maxLength: 250, nullable: false),
                    watch_time3 = table.Column<float>(type: "real", nullable: false),
                    watch_time3_label = table.Column<string>(type: "character varying(250)", maxLength: 250, nullable: false),
                    watch_time4 = table.Column<float>(type: "real", nullable: false),
                    watch_time4_label = table.Column<string>(type: "character varying(250)", maxLength: 250, nullable: false),

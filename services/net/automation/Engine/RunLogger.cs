...
/// <summary>
/// RunLogger class, the buffered writer behind the run's decision log. Every decision is
...
public class RunLogger
{
    ...
    /// <summary>
    /// Creates a new instance of a RunLogger.
    /// </summary>
    /// <param name="api"></param>
    /// <param name="runId"></param>
    /// <param name="variant">The comparison variant ('A'/'B'), or null for a normal run.</param>
    /// <param name="logger"></param>
    public RunLogger(IApiService api, long runId, string? variant, ILogger logger)
    {
        _api = api;
        _runId = runId;
        _variant = variant;

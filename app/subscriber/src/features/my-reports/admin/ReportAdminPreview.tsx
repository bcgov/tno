...
import { Button, ButtonVariant, Col, IReportResultModel, Row, Show } from 'tno-core';
        ...
        <Show visible={!preview}>
          <Col className="diagram" alignContent="center">
            ...
            <Row nowrap>
              ...
              <Col justifyContent="center">
                <p>
                  When a report is run it will generate a snapshot. This represents a moment in time
                  and adds content to the report.
                </p>
              </Col>
            </Row>
            <Row nowrap>

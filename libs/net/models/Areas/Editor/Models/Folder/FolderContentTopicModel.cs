...
/// <summary>
/// FolderContentTopicModel class, provides a model that represents an topic.
/// </summary>
public class FolderContentTopicModel : AuditColumnsModel
{
    #region Properties
    /// <summary>
    ...
    #region Constructors
    /// <summary>
    /// Creates a new instance of an FolderContentTopicModel.
    /// </summary>
    public FolderContentTopicModel() { }

    /// <summary>
    /// Creates a new instance of an FolderContentTopicModel, initializes with specified parameter.
    /// </summary>
    /// <param name="entity"></param>
    public FolderContentTopicModel(Entities.ContentTopic entity) : base(entity)
    {
    ...
    public static explicit operator Entities.ContentTopic(FolderContentTopicModel model)
    {

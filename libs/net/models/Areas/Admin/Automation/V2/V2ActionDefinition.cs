...
/// <summary>
/// V2ActionDefinition class, one action within a step. The action's Type selects its handler;
/// the handler's descriptor (see <see cref="V2ActionCatalog"/>) declares which of the optional
...
/// </summary>
public class V2ActionDefinition
{
    #region Properties
    /// <summary>
    ...
    /// </summary>
    public V2ConditionDefinition? When { get; set; }
    ...
    /// </summary>
    public V2ValueSource? Value { get; set; }
    ...
    /// </summary>
    public V2ConditionDefinition? Where { get; set; }
    ...
    /// </summary>
    public Dictionary<string, V2ValueSource>? Set { get; set; }
...
/// <summary>
/// V2ValueSource class, where an action's value comes from. Exactly one of the three is set;
/// there is nothing to compute.
/// </summary>
public class V2ValueSource
{
    #region Properties
    /// <summary>

...
/// <summary>
/// AnalysisDefinition class, one named LLM prompt with a declared result shape.
...
/// <summary>
/// PromptDefinition class, resolves prompt text from the profile's prompt library and/or

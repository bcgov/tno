...
public class NotificationRequestModel
{
    ...
    /// <param name="to"></param>
    public NotificationRequestModel(int notificationTemplateId, object data, int assignedId, string to = "")
    {
    ...
    /// <param name="assignedId"></param>
    /// <param name="to"></param>
    public NotificationRequestModel(int notificationTemplateId, object data, int requestorId, int assignedId, string to = "")
    ...
    /// <param name="assignedId"></param>
    /// <param name="to"></param>
    public NotificationRequestModel(int notificationTemplateId, long contentId, int assignedId, string to = "")
    {
        this.NotificationTemplateId = notificationTemplateId;
    ...
    /// <param name="assignedId"></param>
    /// <param name="to"></param>
    public NotificationRequestModel(int notificationTemplateId, long contentId, int requestorId, int assignedId, string to = "")

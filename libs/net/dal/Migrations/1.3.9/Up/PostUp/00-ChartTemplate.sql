...
@{
  var datasets = ReportExtensions.GroupContent(SectionSettings.Dataset, Content, Sections, SectionSettings, SectionSettings.DatasetOrder);
  var groups = ReportExtensions.GroupContent(SectionSettings.GroupBy, Content, Sections, SectionSettings, SectionSettings.GroupByOrder);

...
public class OrganizationModel : BaseTypeWithAuditColumnsModel<int>
{
    ...
    /// <summary>
    /// get/set - An array of ministers that belong to this organization.
    /// </summary>
    public IEnumerable<MinisterModel> Ministers { get; set; } = Array.Empty<MinisterModel>();
    ...
    public OrganizationModel(Entities.Organization entity) : base(entity)
    {
        ...
        this.Ministers = entity.Ministers.Select(m => new MinisterModel(m));

...
public class ApiService : IApiService
{
    ...
    private readonly IngestServiceOptions _options;
    #endregion
    ...
    public ApiService(IOpenIdConnectRequestClient client, IOptions<JsonSerializerOptions> serializerOptions, IOptions<IngestServiceOptions> options)
    {
        _client = client;

    ...
    where TOptions : ServiceOptions
{
    ...
    public Task<ServiceActionResult> PerformActionAsync<T>(IServiceActionManager manager, string? name = null, T? data = null, CancellationToken cancellationToken = default) where T : class;
    #endregion
}

...
export const mergeChartSettings = (
  ...
  return {
    ...
    dataLabelBackgroundColors: override.dataLabelBackgroundColors,
    dataLabelFontSize: override.dataLabelFontSize,
    dataLabelAnchors: override.dataLabelAnchors,
    dataLabelAligns: override.dataLabelAligns,
    dataLabelOffsets: override.dataLabelOffsets,
    dataLabelClip: override.dataLabelClip,
    dataLabelClamp: override.dataLabelClamp,
    ...
    options: {
      ...
      plugins: {
        ...
        datalabels: {
          ...
          anchor: override.dataLabelAnchors,
          backgroundColor: override.dataLabelBackgroundColors,
          align: override.dataLabelAligns,
          offset: override.dataLabelOffsets,
          clip: override.dataLabelClip,
          clamp: override.dataLabelClamp,
          labels: {

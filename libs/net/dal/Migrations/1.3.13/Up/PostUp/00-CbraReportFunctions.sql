...
COALESCE(tt.totalrunningtime,0) / CASE COALESCE(tt.totalrunningtime,0) WHEN 0 THEN 1 ELSE COALESCE(tt.totalrunningtime,0) END as percentageoftotalrunningtime 
	from temp_table_by_broadcaster tt;

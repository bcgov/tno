...
/// <summary>
/// V2ConditionDefinition class, a declarative gate on whether an action runs.
/// One of three shapes:
...
/// </summary>
public class V2ConditionDefinition
{
    #region Properties
    /// <summary>
    ...
    /// <summary>
    /// get/set - The leaf operator; see <see cref="V2ConditionOps"/>.
    /// </summary>
    ...
    /// </summary>
    public List<V2ConditionDefinition>? All { get; set; }

    /// <summary>
    /// get/set - At least one child must pass.
    /// </summary>
    public List<V2ConditionDefinition>? Any { get; set; }

    /// <summary>
    /// get/set - The child must fail.
    /// </summary>
    public V2ConditionDefinition? Not { get; set; }
...
/// </summary>
public static class V2ConditionOps
{

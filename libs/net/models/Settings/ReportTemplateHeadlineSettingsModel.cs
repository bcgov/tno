...
public class ReportTemplateHeadlineSettingsModel
{
    #region Properties
    ...
    #region Constructors
    public ReportTemplateHeadlineSettingsModel() { }

    public ReportTemplateHeadlineSettingsModel(Dictionary<string, object> settings, JsonSerializerOptions options)
    {

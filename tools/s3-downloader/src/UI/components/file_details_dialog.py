...
from PySide6.QtWidgets import (
    ...
    QPushButton, QLabel, QLineEdit, QComboBox, QHeaderView, QSizePolicy
)
...
class FileDetailsDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        self.table.setHorizontalHeaderLabels(["File", "Status", "Size", "Download Time", "Error Message"])
    ...
    def update_table(self):
        ...
        # Update status
        self.status_label.setText(f"Total: {len(self.filtered_files)} files, showing {start_idx + 1}-{end_idx}")
        self.update_buttons()

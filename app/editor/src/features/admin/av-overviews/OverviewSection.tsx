...
import { defaultAVOverviewTemplateSectionItem } from './constants';
...
export const OverviewSection: React.FC<IOverviewSectionProps> = ({ index }) => {
  ...
  return (
    <styled.OverviewSection className="section">
      <EditBroadcastDetails
        index={index}
        editable={!section.sourceId && !section.otherSource && !section.seriesId}
      />
      <OverviewGrid index={index} />

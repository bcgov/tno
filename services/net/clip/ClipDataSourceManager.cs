...
/// <summary>
/// ClipDataSourceManager class, provides a way to manage the clip ingestion process for this data source.
/// </summary>
public class ClipDataSourceManager : CommandDataSourceManager<ClipOptions>
{
    #region Variables
    ...
    #region Constructors
    /// <summary>
    /// Creates a new instance of a ClipDataSourceManager object, initializes with specified parameters.
    /// </summary>
    ...
    public ClipDataSourceManager(DataSourceModel dataSource, IApiService api, IIngestAction<ClipOptions> action, IOptions<ClipOptions> options, ILogger<ClipDataSourceManager> logger)
    ...
    {
        if (this.DataSource.ParentId == null ||
            this.DataSource.Parent == null ||
            !this.DataSource.Parent.IsEnabled) return false;
    ...
    public override bool VerifyStartAt(DateTime date, ScheduleModel schedule)
    {
        ...
        var keepChecking = bool.Parse(this.DataSource.GetConnectionValue("keepChecking"));

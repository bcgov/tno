...
public class ContentActionModel
{
    ...
    /// </summary>
    /// <param name="model"></param>
    public ContentActionModel(TNO.API.Areas.Services.Models.Report.ContentActionModel model)
    {
        this.ContentId = model.ContentId;
        this.Id = model.Id;
        this.Name = model.Name ?? "";
    ...
    /// </summary>
    /// <param name="model"></param>
    public ContentActionModel(TNO.API.Areas.Services.Models.ReportInstance.ContentActionModel model)
    {
        this.ContentId = model.ContentId;
        this.Id = model.Id;
        this.Name = model.Name ?? "";

...
namespace MMI.Services.SmtpRetry.Config;

/// <summary>
/// SmtpRetryOptions class, configuration options for notification service
/// </summary>
public class SmtpRetryOptions : ServiceOptions
{
    #region Properties
    /// <summary>

...
export const ExplainPanel: React.FC<IExplainPanelProps> = ({
  ...
  return (
    <Col className="v2-explain-panel" gap="0.5rem">
      ...
      {exchanges.map((exchange, index) => (
        <Col key={index} className="v2-explain-exchange" gap="0.25rem">
          <div className="v2-explain-question">
            <label>You:</label> {exchange.question}
          </div>
          <div className="v2-explain-answer">
            <label>Assistant:</label>
            <pre>{exchange.answer}</pre>
          </div>
          <Show visible={!!exchange.suggestedPrompt}>
            <Col className="v2-explain-suggestion" gap="0.25rem">
